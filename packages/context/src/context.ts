...
import {loggers, Debugger} from '@agentback/common';
...
import {ContextBindings} from './keys.js';
import {
  asResolutionOptions,
  ResolutionError,
  ResolutionOptions,
...
export class Context extends EventEmitter {
   ...
   * const log = loggers('loopback:context:application');
  ...
  constructor(_parent?: Context | string, name?: string) {
    ...
    this._debug = loggers(this.getDebugNamespace()).debug;
  }
