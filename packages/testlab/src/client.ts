...
// supertest v7 renamed `SuperTest<Test>` to `TestAgent<Test>` (returned by
// the default factory). Derive the type from the factory to track upstream.
export type Client = ReturnType<typeof supertest>;
