...
import {LifeCycleObserverRegistry} from './lifecycle-registry.js';
import {Server} from './server.js';
import {createServiceBinding, ServiceOptions} from './service.js';
const log = loggers('loopback:core:application');
const logShutdown = loggers('loopback:core:application:shutdown');
const logWarning = loggers('loopback:core:application:warning');
